...
class GradientBoostingModel(BaseModel):
    ...
    def __init__(self, name: str = "GradientBoosting", target_col: str = None,
        ...
        Args:
            ...
            subsample (float): Fraction of samples used for fitting
    ...
    def train(self, X: pd.DataFrame, y: pd.Series, 
        ...
        Args:
            ...
            monitor_validation (bool): Whether to monitor validation score
            validation_fraction (float): Fraction of data for validation monitoring
    ...
    def get_learning_curve(self) -> dict:
        """
        Get learning curve data (training and validation scores).
    ...
    def find_optimal_n_estimators(self, X: pd.DataFrame, y: pd.Series,
        ...
        """
        Find optimal number of estimators using staged prediction.
        ...
        Returns:
            int: Optimal number of estimators
        """
        if not self.is_trained:
